    ...
    private Map<String, Object> fallbackAnalyze(String message) {
        ...
        if (maxKeywords >= 2) {
            ...
            String riskQuestions = """
                ⚠️ 系統未能確定呢個訊息是否安全。請回答以下問題（是/否）：
                
                ┌─────────────────────────────────────────────────────────┐
                │ 📌 第一部分：緊急程度                                      │
                ├─────────────────────────────────────────────────────────┤
                │ 1. 訊息有冇要求你「立即」採取行動，否則會有壞後果？           │
                │    （例如：「帳戶將被凍結」、「最後機會」、「24小時內」）      │
                └─────────────────────────────────────────────────────────┘
                ...
                ├─────────────────────────────────────────────────────────┤
                │ 3. 訊息聲稱來自邊個機構？                                 │
                │    a) 政府部門（金管局、警方、入境處、水務署等）           │
                │    b) 銀行（匯豐、中銀、恒生等）                          │
                │    c) 支付平台（支付寶、微信支付、八達通等）               │
                │    d) 電商/物流（淘寶、順豐、HKTVmall等）                 │
                │    e) 社交/通訊平台（WhatsApp、Telegram、WeChat等）       │
                │    f) 投資平台（富途、IBKR等）                            │
                │    g) 沒有聲稱 / 其他                                     │
                └─────────────────────────────────────────────────────────┘
                ...
                │ 5. 你同發訊息嘅人關係？                                   │
                │    a) 完全唔認識                                          │
                │    b) 認識，但對方突然用新號碼/新帳戶聯絡我               │
                │    c) 認識，係平時正常聯絡嘅朋友/家人/同事                │
                └─────────────────────────────────────────────────────────┘
                
                ===== 評估指引 =====
                如果：
                - 第1題答「是」→ 高風險
                - 第2題有任何 a/b/c/d/e 答「是」→ 高風險
                - 第3題答 a/b/c/d/e/f 但唔係官方渠道→ 中高風險
                - 第4題有任何 a/b/c/d/e 答「是」→ 中風險
                - 第5題答 a 或 b → 中風險
                
                請小心！如有疑問，可致電防騙易熱線：18222
                """;
